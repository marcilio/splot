...
public class SelectWorkflowHandler extends FreeMarkerHandler {
	...
	public void buildModel(HttpServletRequest request, HttpServletResponse response, Map templateModel) throws HandlerExecutionException {
		...
		try {
	      ...
	      //  List<Map<String,String>> modelList = listWorkflowSpecifications(getServlet().getInitParameter(("parsedWorkflowPath")), sortBy);                
	        List<Map<String,String>> modelList = listWorkflowSpecifications(getServlet().getServletContext().getRealPath("/")+ "extensions/parsed_workflows", sortBy);                
	 ...
	 */
	private List<Map<String,String>> listWorkflowSpecifications(String modelsPath, String sortBy) throws HandlerExecutionException {
